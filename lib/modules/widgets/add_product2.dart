...
//   const AddPrduct(this.refreshChild, this.switchChild, this.todo, this.product,
//       {super.key});
...
//       url1 = product.URL1 ?? '';
//       url2 = product.URL2;
//       firstPhotoUrl.text = url1;
//       secondPhotoUrl.text = url2 ?? '';
//       setState(() {});
//     }
//   }
...
//   _onChangePhotoURLs() {
//     setState(() {
//       url1 = firstPhotoUrl.text;
//       url2 = secondPhotoUrl.text;
//     });
//   }
